...
X_train = pd.read_csv('ACase/ACase_X_train.csv', header=None, delimiter=',').values
X_test = pd.read_csv('ACase/ACase_X_test.csv', header=None, delimiter=',').values

Y_train_pca = pd.read_csv('ACase/ACase_Y_train_pca.csv', header=None, delimiter=',').values
Y_test_pca = pd.read_csv('ACase/ACase_Y_test_pca.csv', header=None, delimiter=',').values
ACase_data_pca = pd.read_csv('ACase/ACase_Y_pca.csv', header=None, delimiter=',').values

# Y_train = pd.read_csv('ACase/ACase_Y_train_std.csv', header=None, delimiter=',').values
# Y_test = pd.read_csv('ACase/ACase_Y_test_std.csv', header=None, delimiter=',').values
# ACase_data = pd.read_csv('ACase/ACase_Y.csv', header=None, delimiter=',').values
...
ACase_y_pca = torch.tensor(ACase_data_pca, dtype=torch.float32)
...
output_file = 'ACase/Result/MVGP_pca_result.csv'
...
checkpoint = torch.load('multitask_gp_checkpoint_ACase_pca.pth', map_location=Device)
...
for row_idx in range(7, ACase_y_pca.shape[0]):
    input_point = ACase_y_pca[row_idx, :]
    ...
    estimated_params_tmp, _ = Estimation.multi_start_estimation(
        MVGP_models, MVGP_likelihoods, row_idx, ACase_y_pca, bounds,
...
# nohup python ACase_pca_PE.py > ACase_pca_PEout.log 2>&1 &