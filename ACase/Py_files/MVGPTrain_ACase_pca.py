...
Y_train_std = pd.read_csv('ACase/ACase_Y_train_pca.csv', header=None, delimiter=',').values
Y_test_std = pd.read_csv('ACase/ACase_Y_test_pca.csv', header=None, delimiter=',').values
...
torch.save(checkpoint, 'multitask_gp_checkpoint_ACase_pca.pth')
print("save 'multitask_gp_checkpoint_ACase_pca.pth'。")


# nohup python MVGPTrain_ACase_pca.py > MVGPTrain_ACase_pcaout.log 2>&1 &