...
ACase_data = pd.read_csv('ACase/ACase_Y_std.csv', header=None, delimiter=',').values

Y_train_std = pd.read_csv('ACase/ACase_Y_train_std.csv', header=None, delimiter=',').values
Y_test_std = pd.read_csv('ACase/ACase_Y_test_std.csv', header=None, delimiter=',').values
...
torch.save(checkpoint, 'multitask_gp_checkpoint_ACase.pth')
print("save 'multitask_gp_checkpoint_ACase.pth'。")



output_file = 'ACase/Result/MVGP_21_result.csv'
mcmc_dir = 'ACase/Result/MVGP_21_mcmc_result'
...
# nohup python MVGP_ACase_test.py > MVGP_ACase_testout.log 2>&1 &